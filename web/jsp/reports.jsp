...
<script type="text/javascript"> 	
	...
	var lifnr = <%=currentUser.getI_LIFNR().toString()%>;
 	var bundle;
 	var userLink;
 	<% if(menusDto.getFlgViewLink()) { %>
 	 var userLink = '<%= menusDto.getLinkVendor() %>'';
 	<% } %>
</script>
...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/ux/FitToParent.js"></script>
<script type="text/javascript" src="<%= URL_AppRelative %>/js/reports.js"></script>
<style>
  ...
  <div class="navbar-inner">  	
    <div class="container" style="width: auto;">     	
      ...
      <% if(menusDto.getReportes()) { %>
      	<li class="active"><a href="<%= URL_AppRelative %>/Reportes?language=${pageContext.response.locale}" id="drop2" role="button" class=""><spring:message code="menu.reports"/></a></li>
      <% } %>
      ...
      <% if(menusDto.getPackingList()) { %>
      	<li class=""><a href="<%= URL_AppRelative %>/PackingList?language=${pageContext.response.locale}" id="drop2" role="button" class="">PackingList</a></li>
      <% } %>
      </ul> 
...
<div style="overflow: hidden; position:absolute; width: 100%; height: 100%;" id="reportsMainPanel"></div>
