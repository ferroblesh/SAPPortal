...
<link rel="stylesheet" type="text/css" href="<%= URL_AppRelative %>/js/ux/LockingGridView.css"/>
<style>
...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/ux/LockingGridView.js"></script>

<script type="text/javascript" src="<%= URL_AppRelative %>/js/packingList.js"></script>
  ...
  <div class="navbar-inner">    
    <div class="container" style="width: auto;">        
      <ul class="nav" role="navigation">
        <li> <a id="fat-menu" href="<%= URL_AppRelative%>/Inicio?language=${pageContext.response.locale}" role="button"><spring:message code="menu.invoicelist"/></a>
      </li>
      ...
      <% } %>
      <% if(menusDto.getReportes()) { %>
        <li class=""><a href="<%= URL_AppRelative %>/Reportes?language=${pageContext.response.locale}" id="drop2" role="button" class=""><spring:message code="menu.reports"/></a></li>
      <% } %>
      ...
      <% } %>
      <% if(menusDto.getPackingList()) { %>
        <li class="active"><a href="<%= URL_AppRelative %>/PackingList?language=${pageContext.response.locale}" id="drop2" role="button" class="">PackingList</a></li>
      <% } %>
      </ul>
