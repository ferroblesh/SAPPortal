...
/**
 * Z_FE_FM_REPORTES_PROVResponse.java
 *
 ...
 */
            ...
            /**
            *  Z_FE_FM_REPORTES_PROVResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FE_FM_REPORTES_PROVResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "urn:sap-com:document:sap:rfc:functions",
                "Z_FE_FM_REPORTES_PROVResponse",
                "ns1");
                        ...
                        */
                                    ...
                                    protected functions.rfc.sap.document.sap_com.ZTT_LISTA_REP_PROV localE_LISTA ;
                                

                           /**
                           * Auto generated getter method
                           * @return functions.rfc.sap.document.sap_com.ZTT_LISTA_REP_PROV
                           */
                           public  functions.rfc.sap.document.sap_com.ZTT_LISTA_REP_PROV getE_LISTA(){
                               return localE_LISTA;
                           }
                            ...
                            /**
                               ...
                               * @param param E_LISTA
                               */
                               public void setE_LISTA(functions.rfc.sap.document.sap_com.ZTT_LISTA_REP_PROV param){
                            
                                            this.localE_LISTA=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FE_FM_REPORTES_PROVResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FE_FM_REPORTES_PROVResponse",
                           xmlWriter);
                                           ...
                                           localE_ID.serialize(new javax.xml.namespace.QName("","E_ID"),
                                            ...
                                            if (localE_LISTA==null){
                                                 throw new org.apache.axis2.databinding.ADBException("E_LISTA cannot be null!!");
                                            }
                                           localE_LISTA.serialize(new javax.xml.namespace.QName("","E_LISTA"),
                                               xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static Z_FE_FM_REPORTES_PROVResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FE_FM_REPORTES_PROVResponse object =
                new Z_FE_FM_REPORTES_PROVResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FE_FM_REPORTES_PROVResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FE_FM_REPORTES_PROVResponse)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","E_LISTA").equals(reader.getName())){
                                
                                                object.setE_LISTA(functions.rfc.sap.document.sap_com.ZTT_LISTA_REP_PROV.Factory.parse(reader));
