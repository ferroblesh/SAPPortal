 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "Z_FE_FM_AGREGAR_FAC_SIN_ORDERResponse",
                "ns1");
                        ...
                        */
                                    ...
                                    protected functions.rfc.sap.document.sap_com.Char10 localE_BELNR ;
                           ...
                           */
                           public  functions.rfc.sap.document.sap_com.Char10 getE_BELNR(){
                               return localE_BELNR;
                           }
                            ...
                            /**
                               ...
                               * @param param E_BELNR
                               */
                               public void setE_BELNR(functions.rfc.sap.document.sap_com.Char10 param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FE_FM_AGREGAR_FAC_SIN_ORDERResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FE_FM_AGREGAR_FAC_SIN_ORDERResponse",
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FE_FM_AGREGAR_FAC_SIN_ORDERResponse".equals(type)){
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","E_BELNR").equals(reader.getName())){
                                                ...
                                                object.setE_BELNR(functions.rfc.sap.document.sap_com.Char10.Factory.parse(reader));
