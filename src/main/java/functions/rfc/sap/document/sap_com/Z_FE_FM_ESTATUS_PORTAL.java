 ...
 */
            ...
            /**
            *  Z_FE_FM_ESTATUS_PORTAL bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FE_FM_ESTATUS_PORTAL
                ...
                "ns1");
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           protected boolean localI_BLDATTracker = false ;

                           public boolean isI_BLDATSpecified(){
                               return localI_BLDATTracker;
                           }
                           ...
                           */
                           public  functions.rfc.sap.document.sap_com.BAPISFLDRA getI_BLDAT(){
                            ...
                            localI_BLDATTracker = param != null;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FE_FM_ESTATUS_PORTAL",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FE_FM_ESTATUS_PORTAL",
    ...
    public static class Factory{
        ...
        */
        public static Z_FE_FM_ESTATUS_PORTAL parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FE_FM_ESTATUS_PORTAL object =
                new Z_FE_FM_ESTATUS_PORTAL();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FE_FM_ESTATUS_PORTAL".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FE_FM_ESTATUS_PORTAL)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
